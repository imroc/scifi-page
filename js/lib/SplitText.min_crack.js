...
!function (a) {
    ...
    var b = a.GreenSockGlobals || a, c = function (a) {
    ...
    }, q = "", r = "SplitText", s = String.fromCharCode(103, 114, 101, 101, 110, 115, 111, 99, 107, 46, 99, 111, 109), t = String.fromCharCode(47, 114, 101, 113, 117, 105, 114, 101, 115, 45, 109, 101, 109, 98, 101, 114, 115, 104, 105, 112, 47), u = true, v = d.SplitText = b.SplitText = function (b, c) {
        ...
        var d = a.nodeType;
        if (1 === d || 9 === d || 11 === d)for (a = a.firstChild; a; a = a.nextSibling)w(a, b, c); else(3 === d || 4 === d) && (a.nodeValue = a.nodeValue.split(b).join(c))
    }, x = function (a, b) {
        ...
        for (I && (J = J.split("++").join("")), K && (j = j.split("<").join("{{LT}}")), P = j.length, S = G(), T = 0; P > T; T++)if (V = j.charAt(T), ")" === V && j.substr(T, 20) === l)S += (L ? F : "") + "<BR/>", L = !1, T !== P - 20 && j.substr(T + 20, 20) !== l && (S += " " + G(), L = !0), T += 19; else if (" " === V && " " !== j.charAt(T - 1) && T !== P - 1 && j.substr(T - 20, 20) !== l) {
            for (S += L ? F : "", L = !1; " " === j.charAt(T + 1);)S += s, T++;
